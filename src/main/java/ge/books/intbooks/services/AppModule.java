...
import ge.books.intbooks.services.impl.BookServiceImpl;
import ge.books.intbooks.services.impl.UserServiceImpl;
...
public class AppModule {
	...
	public static void contributeApplicationDefaults(MappedConfiguration<String, Object> configuration) {
		...
		// match).
		configuration.add(SymbolConstants.SUPPORTED_LOCALES, "ka");
